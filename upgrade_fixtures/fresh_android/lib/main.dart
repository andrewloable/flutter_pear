...
void main() {
  runApp(const FreshAndroidFixtureApp());
}

class FreshAndroidFixtureApp extends StatefulWidget {
  const FreshAndroidFixtureApp({super.key});

  @override
  State<FreshAndroidFixtureApp> createState() =>
      _FreshAndroidFixtureAppState();
}

class _FreshAndroidFixtureAppState extends State<FreshAndroidFixtureApp> {
