...
FLUTTER_PEAR_VERSION=0.2.0-dev.1 ADB_SERIAL=<device-ip>:5555 ./run_check.sh
```
...
device otherwise reachable here (a BYD DiLink automotive head unit) is a different project's hardware and known
